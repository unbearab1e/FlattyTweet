...
namespace FlattyTweet.Model
{
    ...
    public class SettingsData : ISettingsService
    {
        ...
        public string CurrentImageUploadingService = "FlattyTweet.AddIns.TwitterImageUploadService";
        public string CurrentMapService = "FlattyTweet.Google.GoogleService";
        ...
        public bool ShowCompactAccountPane = true;
        ...
        public string Accent = "DarkBlue";
        public ColourAccent AccentColour = ColourAccent.DarkBlue;
        ...
        public string TwitterConsumerSecret
        {
            get
            {
                if (!string.IsNullOrEmpty(this.CustomTwitterConsumerSecret))
                    ...
                    return "qEDhT2ig3j2H4pNGbvTFu5FjbELeJtfvvI48RgX7bs";
            }
        }
