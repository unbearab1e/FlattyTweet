// Type: MetroTwit.Behaviors.MetroMainWindowBehavior
  ...
  public class MetroMainWindowBehavior : Behavior<Window>
  {
    ...
    private static void WmGetMinMaxInfo(IntPtr hwnd, IntPtr lParam)
    {
      ...
      if (num != IntPtr.Zero)
      {
        ...
        MetroTwit.Extensions.RECT rect1 = lpmi.rcWork;
        MetroTwit.Extensions.RECT rect2 = lpmi.rcMonitor;
    ...
    private static int GetEdge(MetroTwit.Extensions.RECT rc)
    {
